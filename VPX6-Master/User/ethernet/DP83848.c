...
void ETH_GPIO_Config(void)
{
  ...
  SYSCFG_ETH_MediaInterfaceConfig(SYSCFG_ETH_MediaInterface_RMII);
	...
	#ifdef RMII_MODE /* Mode MII with STM324xx-EVAL  */
   ...
   /*
	...
	GPIO_PinAFConfig(GPIOB, GPIO_PinSource0, GPIO_AF_ETH); //引脚复用到网络接口上
	GPIO_PinAFConfig(GPIOB, GPIO_PinSource1, GPIO_AF_ETH); //引脚复用到网络接口上
	GPIO_PinAFConfig(GPIOB, GPIO_PinSource8, GPIO_AF_ETH); //引脚复用到网络接口上
	GPIO_PinAFConfig(GPIOB, GPIO_PinSource10, GPIO_AF_ETH); //引脚复用到网络接口上
			
	//配置PC1,PC2,PC3,PC4 and PC5
