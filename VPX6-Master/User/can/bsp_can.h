...
#define CAN_RECEIVE_EXTID						 0x1314

extern CanTxMsg TxMessage;			     //发送缓冲区
extern CanRxMsg Rx1Message;				 //接收缓冲区
extern CanRxMsg Rx2Message;				 //接收缓冲区
...
extern TaskHandle_t CAN2_Task_Handle ;
extern xTaskHandle xCan1Semaphore; 
extern xTaskHandle xCan2Semaphore; 
