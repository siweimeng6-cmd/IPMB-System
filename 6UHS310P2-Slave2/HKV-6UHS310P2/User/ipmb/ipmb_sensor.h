...
#define IPMB_TH_V075_LOW_ASSERT       0.675f  /* V0.75: ±10%窗口 */
#define IPMB_TH_V075_LOW_CLEAR        0.69f
#define IPMB_TH_V075_HIGH_ASSERT      0.825f
#define IPMB_TH_V075_HIGH_CLEAR       0.81f
...
/* 真正的自动阈值检测:对 90Temp/92Temp/V12/V0.75/Iout 五路做迟滞比较,
